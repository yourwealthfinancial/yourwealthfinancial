...
const getErrorMessage = (type, cause) => import.meta.env.PROD ? getErrorMessageProd(type) : getErrorMessageDev(type, cause);
...
var SerovalUnsupportedTypeError = class extends Error {
	constructor(value) {
		super(import.meta.env.PROD ? getSpecificErrorMessage(1) : `The value ${objectToString.call(value)} of type "${typeof value}" cannot be parsed/serialized.
...
var SerovalUnsupportedNodeError = class extends Error {
	constructor(node) {
		super(import.meta.env.PROD ? getSpecificErrorMessage(2) : "Unsupported node type \"" + node.t + "\".");
	}
};
var SerovalMissingPluginError = class extends Error {
	constructor(tag) {
		super(import.meta.env.PROD ? getSpecificErrorMessage(3) : "Missing plugin for tag \"" + tag + "\".");
	}
};
var SerovalMissingInstanceError = class extends Error {
	constructor(tag) {
		super(import.meta.env.PROD ? getSpecificErrorMessage(4) : "Missing \"" + tag + "\" instance.");
	}
};
var SerovalMissingReferenceError = class extends Error {
	constructor(value) {
		super(import.meta.env.PROD ? getSpecificErrorMessage(5) : "Missing reference for the value \"" + objectToString.call(value) + "\" of type \"" + typeof value + "\"");
		this.value = value;
	}
};
var SerovalMissingReferenceForIdError = class extends Error {
	constructor(id) {
		super(import.meta.env.PROD ? getSpecificErrorMessage(6) : "Missing reference for id \"" + serializeString(id) + "\"");
	}
};
var SerovalUnknownTypedArrayError = class extends Error {
	constructor(name) {
		super(import.meta.env.PROD ? getSpecificErrorMessage(7) : "Unknown TypedArray \"" + name + "\"");
	}
};
var SerovalMalformedNodeError = class extends Error {
	constructor(node) {
		super(import.meta.env.PROD ? getSpecificErrorMessage(8) : "Malformed node type \"" + node.t + "\".");
	}
};
var SerovalConflictedNodeIdError = class extends Error {
	constructor(node) {
		super(import.meta.env.PROD ? getSpecificErrorMessage(9) : "Conflicted node id \"" + node.i + "\".");
	}
};
var SerovalDepthLimitError = class extends Error {
	constructor(limit) {
		super(import.meta.env.PROD ? getSpecificErrorMessage(9) : "Depth limit of " + limit + " reached");
	}
};
//#endregion
